...
public class HibernateUtil_CompositeQuery_Stores {

	public static Predicate get_aPredicate_For_AnyDB(CriteriaBuilder builder, Root<StoresVO> root, String columnName, String value) {

		Predicate predicate = null;
		
		if ("storeId".equals(columnName)||"pushUp".equals(columnName)) // 用於Integer
			predicate = builder.equal(root.get(columnName), Integer.valueOf(value));
		else if ("storeAccount".equals(columnName)||"storeName".equals(columnName)||"storeGui".equals(columnName)||"storeAddress".equals(columnName)
				||"storePhone".equals(columnName)||"storeState".equals(columnName)||"storeLv".equals(columnName)
				||"ownerName".equals(columnName)||"ownerMob".equals(columnName)||"ownerId".equals(columnName)||"ownerEmail".equals(columnName)) // 用於varchar
			predicate = builder.like(root.get(columnName), "%" + value + "%");
		else if ("createDate".equals(columnName)||"payDate".equals(columnName)) { // 用於date
