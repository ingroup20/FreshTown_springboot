...
public class HibernateUtil_CompositeQuery_Material {
	...
	public static Predicate get_aPredicate_For_AnyDB(CriteriaBuilder builder, Root<MaterialVO> root, String columnName, String value) {
		...
		if ("itemNumber".equals(columnName)) // 用於Integer
			predicate = builder.equal(root.get(columnName), Integer.valueOf(value));
		else if ("itemName".equals(columnName) || "itemClassId".equals(columnName)
				|| "stockQuantity".equals(columnName) || "quantityNot".equals(columnName)
				|| "itemUnit".equals(columnName) || "safetyStock".equals(columnName) 
				|| "itemStatus".equals(columnName) || "storeId".equals(columnName)) // 用於varchar
